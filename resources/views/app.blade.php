    ...
    <div class="collapse navbar-collapse" id="navbar-collapse-top-menu">
      ...
      <ul class="nav navbar-nav">
        @unless (Auth::guest())
          ...
          <li @if (Request::is('opportunity') || Request::is('opportunity/*')) class="ui-state-default" @endif><a
              href="/opportunity">Opportunities</a></li>
          <li @if (Request::is('report') || Request::is('report/*')) class="ui-state-default" @endif><a href="/report">Reports</a>
          </li>
        @endunless
      </ul>
