...
@section('content')
  ...
  <div class="container lightBorder rowHighlight">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="row">
          ...
          <div
            class="col-xs-7">{{ \App\AppHelper::optionValueFromDB('lkp_account_ownership', $record->ownership_id) }}</div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="row">
          ...
          <div
            class="col-xs-7">{{ \App\AppHelper::optionValueFromDB('lkp_lead_source', $record->lead_source_id) }}</div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="row">
          ...
          <div class="col-xs-7">{{ $record->street }} <br> {{ $record->city }}, {{ $record->state }}, {{ $record->zip }}
      ...
      <div class="col-sm-6">
        <div class="row">
          ...
          <div class="col-xs-7">{{ $record->street_other }} <br> {{ $record->city_other }}, {{ $record->state_other }}
    ...
    <div class="row">
      <form id="deleteAccountForm" method="post" action="/account/{{ $record->id }}" accept-charset="UTF-8" role="form"
        ...
        <div class="form-group form-group-sm">
          <div class="col-xs-12 text-center">
            ...
            <input type="button" value="Delete" class="btn btn-primary"
                   onClick="if (confirm('Are you sure you want to delete this record?')) document.getElementById('deleteAccountForm').submit()">
          </div>
        </div>
      </form>
    </div>
