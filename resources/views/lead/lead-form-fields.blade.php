...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><input type="text" id="company" name="company" class="form-control"
                                 value="{{ $record->company }}"></div>
  </div>
...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><select id="industry_id" name="industry_id"
...
<div class="form-group">
  ...
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><select id="rating_id" name="rating_id"
...
<div class="form-group">
  ...
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><select id="status_id" name="status_id"
                                  class="form-control">{!! \App\AppHelper::optionListFromDB('lkp_lead_status', $record->status_id) !!}</select>
    </div>
  </div>
</div>
