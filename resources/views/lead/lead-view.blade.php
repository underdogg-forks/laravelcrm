...
@section('content')
  ...
  <div class="container lightBorder rowHighlight">
    ...
    <div class="row">
      ...
      <div class="col-xs-8 col-sm-10">{{ $record->street }} <br> {{ $record->city }}, {{ $record->state }}
        , {{ $record->zip }} <br> {{ \App\AppHelper::optionValueCountry($record->country) }}</div>
    </div>
    ...
    <div class="row">
      <form id="deleteLeadForm" method="post" action="/lead/{{ $record->id }}" accept-charset="UTF-8" role="form"
        ...
        <div class="form-group form-group-sm">
          <div class="col-xs-12 text-center">
            ...
            <input type="button" value="Delete" class="btn btn-primary"
                   onClick="if (confirm('Are you sure you want to delete this record?')) document.getElementById('deleteLeadForm').submit()">
