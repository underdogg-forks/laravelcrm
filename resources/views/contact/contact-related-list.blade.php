...
<div class="container">
  <div class="row relatedListStart">
    <div>Contacts</div>
    <a href="/contact/create?account_id={{ $record->id }}" class="btn btn-primary btn-xs">Add New Contact</a>
  </div>
        ...
        @if (count($contactList))
          @foreach ($contactList as $record)
            <tr>
              ...
              <td class="text-small"><a href="/contact/{{ $record->id }}">View</a>&nbsp;&nbsp;&nbsp;<a
                  href="/contact/{{ $record->id }}/edit">Edit</a></td>
            </tr>
          @endforeach
        @else
          <tr>
