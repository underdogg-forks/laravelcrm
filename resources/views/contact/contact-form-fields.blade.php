<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-3"><select id="salutation_id" name="salutation_id"
                                  class="form-control">{!! \App\AppHelper::optionListFromDB('lkp_salutation', $record->salutation_id) !!}</select>
    </div>
    <div class="col-xs-5"><input type="text" id="first_name" name="first_name" class="form-control"
                                 value="{{ $record->first_name }}"></div>
  </div>

  <div class="col-sm-6">
    <label for="last_name" class="control-label ui-state-default text-nowrap col-xs-4">Last Name:</label>
    <div class="col-xs-8"><input type="text" id="last_name" name="last_name" class="form-control"
                                 value="{{ $record->last_name }}"></div>
  </div>
</div>
...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div id="account_name" class="col-xs-6"
         style="margin-top:6px; margin-bottom:6px">{{ \App\AppHelper::valueFromDB('accounts', $record->account_id) }}</div>
    <div class="col-xs-2" style="margin-top:6px; margin-bottom:6px"> [<a href="javascript:void(0)"
                                                                         onclick="showChangeAccountWindow()">Change</a>]
    </div>
  </div>

  <div class="col-sm-6">
    <label for="type_id" class="control-label ui-state-default text-nowrap col-xs-4">Contact Type:</label>
    <div class="col-xs-8"><select id="type_id" name="type_id"
                                  class="form-control">{!! \App\AppHelper::optionListFromDB('lkp_contact_type', $record->type_id) !!}</select>
    </div>
  </div>
</div>
...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><input type="text" id="title" name="title" class="form-control" value="{{ $record->title }}">
    </div>
  </div>

  <div class="col-sm-6">
    <label for="department" class="control-label ui-state-default text-nowrap col-xs-4">Department:</label>
    <div class="col-xs-8"><input type="text" id="department" name="department" class="form-control"
                                 value="{{ $record->department }}"></div>
  </div>
</div>
...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><input type="text" id="email" name="email" class="form-control" value="{{ $record->email }}">
    </div>
  </div>

  <div class="col-sm-6">
    <label for="phone" class="control-label ui-state-default text-nowrap col-xs-4">Phone:</label>
    <div class="col-xs-8"><input type="text" id="phone" name="phone" class="form-control" value="{{ $record->phone }}">
    </div>
  </div>
</div>
...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><input type="text" id="mobile_phone" name="mobile_phone" class="form-control"
                                 value="{{ $record->mobile_phone }}"></div>
  </div>

  <div class="col-sm-6">
    <label for="home_phone" class="control-label ui-state-default text-nowrap col-xs-4">Home Phone:</label>
    <div class="col-xs-8"><input type="text" id="home_phone" name="home_phone" class="form-control"
                                 value="{{ $record->home_phone }}"></div>
  </div>
</div>
...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><input type="text" id="other_phone" name="other_phone" class="form-control"
                                 value="{{ $record->other_phone }}"></div>
  </div>
...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><input type="text" id="assistant" name="assistant" class="form-control"
                                 value="{{ $record->assistant }}"></div>
  </div>

  <div class="col-sm-6">
    <label for="assistant_phone" class="control-label ui-state-default text-nowrap col-xs-4">Assist. Phone:</label>
    <div class="col-xs-8"><input type="text" id="assistant_phone" name="assistant_phone" class="form-control"
                                 value="{{ $record->assistant_phone }}"></div>
  </div>
</div>
...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><input type="text" id="birthdate" name="birthdate" class="form-control"
                                 value="{{ $record->birthdate }}"></div>
  </div>

  <div class="col-sm-6">
    <label for="interests" class="control-label ui-state-default text-nowrap col-xs-4">Interests:</label>
    <div class="col-xs-8"><input type="text" id="interests" name="interests" class="form-control"
                                 value="{{ $record->interests }}"></select></div>
  </div>
</div>
...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><select id="lead_source_id" name="lead_source_id"
                                  class="form-control">{!! \App\AppHelper::optionListFromDB('lkp_lead_source', $record->lead_source_id) !!}</select>
    </div>
  </div>
...
<div class="form-group">
  <div class="col-xs-4 col-sm-3 col-md-2 col-md-offset-1 text-nowrap">
    ...
    <input type="checkbox" id="do_not_call" name="do_not_call"
           value="1" @if ($record->do_not_call) {{ 'checked' }} @endif>
  </div>
  <div class="col-xs-4 col-sm-3 col-md-2 text-nowrap">
    ...
    <input type="checkbox" id="do_not_email" name="do_not_email"
           value="1" @if ($record->do_not_email) {{ 'checked' }} @endif>
  </div>
  <div class="col-xs-4 col-sm-3 col-md-2 text-nowrap">
  ...
  <div class="col-xs-6 col-sm-3 col-md-2 text-nowrap">
    ...
    <input type="checkbox" id="email_opt_out" name="email_opt_out"
           value="1" @if ($record->email_opt_out) {{ 'checked' }} @endif>
  </div>
  <div class="col-xs-6 col-sm-3 col-md-2 text-nowrap">
    <label for="do_not_call" class="control-label ui-state-default text-nowrap">&nbsp;Fax Opt Out :&nbsp;</label>
    <input type="checkbox" id="fax_opt_out" name="fax_opt_out"
           value="1" @if ($record->fax_opt_out) {{ 'checked' }} @endif>
  </div>
</div>
...
<div class="form-group">
  <div class="col-sm-12">
    ...
    <div class="col-xs-8 col-sm-10"><input type="text" id="street" name="street" class="form-control"
                                           value="{{ $record->street }}"></div>
  </div>
</div>
...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><input type="text" id="city" name="city" class="form-control" value="{{ $record->city }}">
    </div>
  </div>

  <div class="col-sm-6">
    <label for="state" class="control-label ui-state-default text-nowrap col-xs-4">State:</label>
    <div class="col-xs-8"><input type="text" id="state" name="state" class="form-control" value="{{ $record->state }}">
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><select id="country" name="country"
                                  class="form-control">{!! \App\AppHelper::optionListCountry($record->country) !!}</select>
    </div>
  </div>
</div>
...
<div class="form-group">
  <div class="col-sm-12">
    ...
    <div class="col-xs-8 col-sm-10"><input type="text" id="street_other" name="street_other" class="form-control"
                                           value="{{ $record->street_other }}"></div>
  </div>
</div>
...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><input type="text" id="city_other" name="city_other" class="form-control"
                                 value="{{ $record->city_other }}"></div>
  </div>

  <div class="col-sm-6">
    <label for="state_other" class="control-label ui-state-default text-nowrap col-xs-4">State:</label>
    <div class="col-xs-8"><input type="text" id="state_other" name="state_other" class="form-control"
                                 value="{{ $record->state_other }}"></div>
  </div>
</div>
...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><input type="text" id="zip_other" name="zip_other" class="form-control"
                                 value="{{ $record->zip_other }}"></div>
  </div>

  <div class="col-sm-6">
    <label for="country_other" class="control-label ui-state-default text-nowrap col-xs-4">Country:</label>
    <div class="col-xs-8"><select id="country_other" name="country_other"
                                  class="form-control">{!! \App\AppHelper::optionListCountry($record->country_other) !!}</select>
    </div>
  </div>
</div>
...
<div class="form-group">
  <div class="col-sm-6">
    ...
    <div class="col-xs-8"><textarea id="description" name="description"
                                    class="form-control">{{ $record->description }}</textarea></div>
  </div>

  <div class="col-sm-6">
    <label for="owner_id" class="control-label ui-state-default text-nowrap col-xs-4">Owner:</label>
    <div class="col-xs-8"><select id="owner_id" name="owner_id"
                                  class="form-control">{!! \App\AppHelper::optionListFromDB('users', $record->owner_id) !!}</select>
    </div>
  </div>
</div>
