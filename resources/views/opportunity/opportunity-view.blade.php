...
@section('content')
  ...
  <div class="container lightBorder rowHighlight">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="row">
          ...
          <div
            class="col-xs-8">{{ \App\AppHelper::optionValueFromDB('lkp_opportunity_stage', $record->stage_id) }}</div>
        </div>
      </div>
    ...
    <div class="row">
      <form id="deleteOpportunityForm" method="post" action="/opportunity/{{ $record->id }}" accept-charset="UTF-8"
        ...
        <div class="form-group form-group-sm">
          <div class="col-xs-12 text-center">
            ...
            <input type="button" value="Delete" class="btn btn-primary"
                   onClick="if (confirm('Are you sure you want to delete this record?')) document.getElementById('deleteOpportunityForm').submit()">
          </div>
        </div>
      </form>
    </div>
