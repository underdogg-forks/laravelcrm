...
<div class="container">
  <div class="row relatedListStart">
    ...
    <a href="/opportunity/create?contact_id={{ $record->id }}" class="btn btn-primary btn-xs">Add New Opportunity</a>
  </div>
        ...
        @if (count($opportunityList))
          @foreach ($opportunityList as $record)
            <tr>
              ...
              <td class="text-small"><a href="/opportunity/{{ $record->id }}">View</a>&nbsp;&nbsp;&nbsp;<a
                  href="/opportunity/{{ $record->id }}/edit">Edit</a></td>
            </tr>
          @endforeach
        @else
          <tr>
