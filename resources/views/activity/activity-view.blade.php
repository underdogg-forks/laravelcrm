...
@section('content')
  ...
  <div class="container lightBorder rowHighlight">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="row">
          ...
          <div
            class="col-xs-8">{{ \App\AppHelper::optionValueFromDB('lkp_activity_priority', $record->priority_id) }}</div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="row">
          ...
          <div
            class="col-xs-8">{{ \App\AppHelper::optionValueFromDB('users', $record->adder_id) }} {{ $record->created_at }}</div>
        </div>
      </div>
      ...
      <div class="col-sm-6">
        <div class="row">
          ...
          <div
            class="col-xs-8">{{ \App\AppHelper::optionValueFromDB('users', $record->modifier_id) }} {{ $record->updated_at}}</div>
        </div>
      </div>
    </div>
    ...
    <form id="deleteActivityForm" method="post" action="/activity/{{ $record->id }}" accept-charset="UTF-8" role="form"
      ...
      <div class="form-group form-group-sm">
        <div class="col-xs-12 text-center">
          ...
          <input type="button" value="Delete" class="btn btn-primary"
                 onClick="if (confirm('Are you sure you want to delete this record?')) document.getElementById('deleteActivityForm').submit()">
