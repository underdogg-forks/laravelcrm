    ...
    public function __construct()
    {
        ...
        if ($this->related_id) {
            switch ($this->related_type) {
                case 'lead':
                    $this->relates_to = AppHelper::valueFromDB('leads', $this->related_id);
                    break;
                case 'contact':
                    $this->relates_to = AppHelper::valueFromDB('contacts', $this->related_id);
                    break;
                case 'account':
                    $this->relates_to = AppHelper::valueFromDB('accounts', $this->related_id);
                    break;
                case 'opportunity':
                    $this->relates_to = AppHelper::valueFromDB('opportunities', $this->related_id);
                    break;
                default:
                    $this->relates_to = '';
            }
